...
//     fireButton.onclick = handleFireButton; // run handleFireButton function
...
function getIdElement(element_id) {
    var guessFromInput = element_id;
    controller.processGuess(guessFromInput);
}
